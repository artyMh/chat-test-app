...
const WsMessage = require('./ws-message').WsMessage;
const UsersStore = require('./users-nickname-store').UsersStore;
const WsCloseCodes = require('./enums/ws-close-codes').WsCloseCodes;
...
function processNotRegistered(ws, msg) {
